...
if key_check in dict1:  #check if input key in a dict1 or not
    print(f"The key {key_check} exists in the dictionary.")     #display key already exists in a dictionary
else:
    print(f"The key {key_check} dose not exists in the dictionary.")    #display key not exists in a dictionary